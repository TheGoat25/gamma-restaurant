...
public class napoletanaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_napoletana);
        ...
        order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mHashmap.put("Food", "PIZZA NAPOLETNA"); // update food order
