...
public class RoomDeliveryForm extends AppCompatActivity {

    ImageButton cancel;
    Button submit;
    EditText customer_name, room_number, email, phone_number, special_instructions;

    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.room_delivery_form);
        ...
        room_number = (EditText) findViewById(R.id.HotelRoomNumber);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mHashmap.put("Hotel Room Number", roomNumber); // update hotel room #
                ...
                mHashmap.put("Service Type", "Room Service"); // update the service type
    ...
    // Room Delivery Confirmation Activity Method
    public void openRoomDeliveryConfirmation() {
        Intent intent = new Intent(this, RoomDeliveryConfirmation.class);
        startActivity(intent);
    }
}
